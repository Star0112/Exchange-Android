...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.drawable.indicator_selected;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.indicator_selected;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.indicator_selected, R.drawable.indicator_selected);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.indicator_selected
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =

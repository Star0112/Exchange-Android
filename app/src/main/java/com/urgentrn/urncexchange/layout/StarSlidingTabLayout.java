...
public class StarSlidingTabLayout extends HorizontalScrollView {
    ...
    private final StarSlidingTabStrip mTabStrip;

    public StarSlidingTabLayout(Context context) {
        this(context, null);
    }

    public StarSlidingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StarSlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabStrip = new StarSlidingTabStrip(context);
     ...
     *
     * @see androidx.viewpager.widget.ViewPager#setOnPageChangeListener(androidx.viewpager.widget.ViewPager.OnPageChangeListener)
     */

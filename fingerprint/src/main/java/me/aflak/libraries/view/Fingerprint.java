...
public class Fingerprint extends RelativeLayout {
    ...
    public static boolean isAvailable(Context context){
        ...
        final FingerprintManager manager = (FingerprintManager) context.getSystemService(Context.FINGERPRINT_SERVICE);
    ...
    public void authenticate(){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && fingerprintManager.isHardwareDetected() && fingerprintManager.hasEnrolledFingerprints()) {

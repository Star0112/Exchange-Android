...
public class AnimatedDialog<T extends AnimatedDialog> {
    ...
    public T titleFont(int resFont){
        this.titleFont = resFont;
        return (T) this;
    }

    public T messageFont(int resFont){
        this.messageFont = resFont;
        return (T) this;
    }

    public T passwordText(String passwordText){
        this.passwordText = passwordText;
        return (T) this;
    }

    public T cancelText(String cancelText){
        this.cancelText = cancelText;
        return (T) this;
    }

    public T passwordText(int resPasswordText){
        this.passwordText = context.getResources().getString(resPasswordText);
        return (T) this;
    }

    public T cancelText(int resCancelText){
        this.cancelText = context.getResources().getString(resCancelText);
        return (T) this;
    }

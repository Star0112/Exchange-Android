...
public class FingerprintDialog extends AnimatedDialog<FingerprintDialog> {
    ...
    private void showDialog(){
        ...
        if (titleFont != 0) {
            dialogTitle.setTypeface(ResourcesCompat.getFont(context, titleFont));
            usePasswordButton.setTypeface(ResourcesCompat.getFont(context, titleFont));
            cancelButton.setTypeface(ResourcesCompat.getFont(context, titleFont));
        }
        if (messageFont != 0) {
            dialogMessage.setTypeface(ResourcesCompat.getFont(context, messageFont));
            dialogStatus.setTypeface(ResourcesCompat.getFont(context, messageFont));
        }
        cancelButton.setText(cancelText != null ? cancelText : context.getString(R.string.fingerprint_cancel));
        usePasswordButton.setText(passwordText != null ? passwordText : context.getString(R.string.fingerprint_use_password));
